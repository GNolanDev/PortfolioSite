      ...
      <section id="mainContent">
        ...
        <ul id="skillsContainer">
          ...
          <li class="skill" id="css3">
            <div class="skill-logo">
              <img
                src="assets/images/logos/tech/CSS3_logo.svg"
                alt="css3 logo"
              />
            </div>
            <h2>CSS3</h2>
          ...
          <li class="skill" id="sql">
            <div class="skill-logo">
              <img
                src="assets/images/logos/tech/mariadb_v_white.svg"
                alt="mariadb logo"
              />
            </div>
            <h2>SQL</h2>
          ...
          <li class="skill" id="android">
            <div class="skill-logo">
              <img
                src="assets/images//logos/tech/Android.svg"
                alt="android(TM) logo"
              />
            </div>
            <h2>Android</h2>
          ...
          <li class="skill" id="python">
            <div class="skill-logo">
              <img
                src="assets/images/logos/tech/python.svg"
                alt="python logo"
              />
            </div>
            <h2>Python</h2>
