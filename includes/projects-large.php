<section class="projects-page-content-section large-projects">
    <div class="project">
        ...
        <div class="project-description">
            <label>
                <input class="description-checkbox sr-only" type="checkbox">
                <span class="sr-only">Timerthing description</span>
                <div class="project-description-inner moretext"></div>
                <div class="project-description-inner">
                    Timerthing is a public website I built from scratch to solve the problem of recording and storing times for a volunteer-led local running group following the closure of the national organisation which previously supported it. Users sign up and get a personal QR code, which event organisers can then scan in using an event timing page of the same application. Names are fetched from the server during the live event; multiple devices can be used for timing the same event; unknown finishers can be added, along with temporary names which users can 'claim' later; emergency contact info can optionally be added which can be made available to organisers or even just anyone with a smart phone since the QR code represents a real URL. Anyone with an account can set up their own location, with multiple events at each location, all of which can be run simultaneously in separate tabs. HTML, CSS, & Javascript is used for the front end & most of the actual timing functionality, making use of the IndexedDB and localStorage Web APIs to allow seamless continued timing without data loss in case the browser sesssion is closed. JSON is used for communicating with the API created on the server side in PHP, with live events and long term storage, user account info etc all handled in MySQL (MariaDB during local development on XAMPP server).
    ...
    <div class="project">
        ...
        <div class="project-description">
            <label>
                <input class="description-checkbox sr-only" type="checkbox" name="Sailor's Mate Description">
                <span class="sr-only">Sailor's Mate description</span>
                <div class="project-description-inner moretext"></div>
                <div class="project-description-inner">
