<section class="projects-page-content-section large-projects">
    ...
    <div class="project">
        ...
        <div class="project-link"><a href="https://play.google.com/store/apps/details?id=com.gingerphysics.sailorsmate">Link to Sailor's Mate (Google Play Store)<div class="project-inline-icon project-icon-playstore"></div></a>
        </div>
        <div class="project-technology-icons">
            <div class="project-icon-android"></div>
            <div class="project-icon-xml"></div>
            <div class="project-icon-java"></div>
        </div>
    </div>
</section>
